...
//#include "../thirdpart/cholmod/include/cholmod.h"
#include "cholmod.h"
#include <cassert>
#include <algorithm>
#include <vector>
...
public:
   ...
   // typedef double T;//T NT;
    typedef double YY;
private:
    template<class U> struct Cholmod_dtype {enum { DTYPE = CHOLMOD_DOUBLE };};
...
public:
    ...
    Cholmod_symmetric_matrix(int  rows,                 ///< Matrix dimensions.
                             ...
                             cholmod_common *common = NULL)  ///< Max number of non 0 elements in the
